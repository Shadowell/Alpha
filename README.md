...
![大盘总览-市场情绪+热门概念](docs/screenshots/01-market-1.png)

![大盘总览-热门个股Top30](docs/screenshots/01-market-2.png)
...
![数据中心-健康仪表盘+同步操作+任务历史](docs/screenshots/02-data-1.png)

![数据中心-完整性报告+同步日志](docs/screenshots/02-data-2.png)
...
![策略选股-三池漏斗](docs/screenshots/03-funnel.png)
...
![公告选股-概览+三池](docs/screenshots/04-notice.png)
...
![智能监控-Agent状态+监控面板+消息流](docs/screenshots/05-agent-1.png)

![智能监控-主线分析卡片详情](docs/screenshots/05-agent-2.png)
...
![模拟盘-账户总览+当前持仓](docs/screenshots/06-paper-1.png)

![模拟盘-平仓历史+成交记录](docs/screenshots/06-paper-2.png)
...
预测 K 线在图表中以**黄色半透明虚线框**展示，与历史 K 线无缝衔接。
